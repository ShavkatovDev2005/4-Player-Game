...
public class player2_knife : MonoBehaviour
{
    public static player2_knife Instance;
    ...
    void Start()
    {
        selected_knife = PlayerPrefs.GetInt("knife2",0);
    ...
    public void buttonExit()
    {
        ...
        if (imkoniyat<5 && hayatta) 
        {
            ...
            shootable.GetComponent<knife>().hangi_oyuncu_atti=2;
