...
public class player1_knife : MonoBehaviour
{
    public static player1_knife Instance;
    ...
    void Start()
    {
        selected_knife = PlayerPrefs.GetInt("knife1",0);
    ...
    public void buttonExit()
    {
        ...
        if (imkoniyat<5 && hayatta) 
        {
            ...
            shootable.GetComponent<knife>().hangi_oyuncu_atti=1;
