...
public class ML4_tank : Agent
{
    ...
    public static ML4_tank Instance;
    ...
    void Start()
    {
        ...
        spriteRenderer.sprite=other_setting_tank.Instance._tanklar_sprite[PlayerPrefs.GetInt("tank4",3)];//tank sprite sec
