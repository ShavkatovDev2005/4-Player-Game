...
public class ML2_tank : Agent
{
    ...
    public static ML2_tank Instance;
    ...
    void Start()
    {
        ...
        spriteRenderer.sprite=other_setting_tank.Instance._tanklar_sprite[PlayerPrefs.GetInt("tank2",1)];//tank sprite sec
