...
public class player_tank4 : MonoBehaviour
{
    public static player_tank4 Instance;
    float turnSpeed=100;
    float moveSpeed=3;
    bool turnRight;
    ...
    void Start()
    {
        ...
        spriteRenderer.sprite=other_setting_tank.Instance._tanklar_sprite[PlayerPrefs.GetInt("tank4",3)];
