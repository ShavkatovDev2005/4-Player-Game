...
public class SpriteBaraban : MonoBehaviour
{
    ...
    public int al()
    {
        ...
        if (hangi_spritede_durdu==0){
            audiosource.PlayOneShot(audio1);
            hangi_spritede_durdu=-1;
            return 1;
        }
        else if (hangi_spritede_durdu==1){
            audiosource.PlayOneShot(audio1);
            hangi_spritede_durdu=-1;
            return 3;
        }
        else if (hangi_spritede_durdu==2){
            audiosource.PlayOneShot(audio1);
            hangi_spritede_durdu=-1;
            return 5;
        }
        else if (hangi_spritede_durdu==3){
            audiosource.PlayOneShot(audio1);
            hangi_spritede_durdu=-1;
            return 10;
        }
        else if (hangi_spritede_durdu==4 || hangi_spritede_durdu==5){
            audiosource.PlayOneShot(audio1);
            hangi_spritede_durdu=-1;
            return -10;
        }
