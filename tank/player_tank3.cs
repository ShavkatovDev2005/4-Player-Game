...
public class player_tank3 : MonoBehaviour
{
    public static player_tank3 Instance;
    float turnSpeed=100;
    float moveSpeed=3;
    bool turnRight;
    ...
    void Start()
    {
        ...
        spriteRenderer.sprite=other_setting_tank.Instance._tanklar_sprite[PlayerPrefs.GetInt("tank3",2)];
