...
public class player_tank2 : MonoBehaviour
{
    public static player_tank2 Instance;
    float turnSpeed=100;
    float moveSpeed=3;
    bool turnRight;
    ...
    void Start()
    {
        ...
        spriteRenderer.sprite=other_setting_tank.Instance._tanklar_sprite[PlayerPrefs.GetInt("tank2",1)];
    ...
    public void player2(int harakat_button)//button ayar
    {
